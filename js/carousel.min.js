...
_warticles = filter_and_order_articles(_articles, c_id, null, 1, 'score');
if (_warticles.length < WARTICLES_PER_PAGE){WARTICLES_PER_PAGE=_warticles.length;}
...
if (_articles_length < ARTICLES_PER_PAGE){ARTICLES_PER_PAGE=_articles_length;}
if (_articles_length != 0){
