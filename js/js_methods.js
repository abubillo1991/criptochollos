...
function add_article_card(id, name, category_id, intro_description, date, score, status, image, price, ad) {
  ...
  _article_card += '</div></div></div></div><div class="product-card__rating-legend">' + score + '</div></div><p class="product-card__features-list">' + intro_description + '</p></div><div class="product-card__actions"><div class="product-card__availability">Estado: ';
