...
function add_article_card(id, name, category_id, intro_description, date, score, status, image, price, url, user, ref) {
  ...
  _article_card += '</span></div><div class="product-card__prices">' + price + '</div><div class="d-grid gap-2"><a class="btn btn-success btn-lg text-white" type="button" target="_blank" href="' + ref + '">Ir al chollo</a></div>';
